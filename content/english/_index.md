...
# Banner
banner:
  title: Welcome to your safe space to understand your disabled identity.
  content:
  image: /images/landing_banner.png

# Features - These are page sections.  Each section is split by title.
features:
  - title: Feeling overwhelmed or unsure about how to survive in our current society with a disability?
  ...
  - title: Reality of Disability and why I’m doing what I’m doing
    ...
    content: 
      ...
      I’m very comfortable reading the government legalese that often accompanies these types of programs.I also have delved deeply into the disabled identity and understanding the social, emotional, and psychological impacts that being identified as disabled can have on people, as well as how people react to others with that identity. It isn’t pretty, but it’s vital to understand.<br /><br />

      My degree gave me a deeper understanding of group psychology, the impacts of organizational culture, and systemic inequalities(how laws or rules that seem unbiased often work against minority identities).<br /><br />

      I’m living with multiple disabilities, the most obvious and impactful of which is Functional Neurological Disorder(FND), a poorly understood condition with roots in hysteria. In my case, it often expresses as uncontrolled muscle movements, from muscle jerks to rocking motions, to individual muscle groups doing strange things(like knees refusing to bend or legs suddenly failing to hold me up). It’s also stress-responsive, so the worse anyone(myself or others) responds, the worse the symptoms are likely to get.<br /><br />

      I want others to benefit from the knowledge I’ve accumulated, especially because I know that I had multiple privileges that helped me make it through all of this. I want to be able to help you get through it all too, so you can also succeed despite the odds and know just why the process is so hard anyway(hint: it’s not your fault!"
    button:
      enable: true
      label: "Click Here to buy one of my books!"
      link: /services
  - title: How Do I Help?
